...
% Example 2 from Costate Estimation by a Legendre Pseudospectral Method 
...
plot(t,E,'r.-',t,atan(lamu./lamv),'bo');
xlabel('t [sec]');
ylabel('Control Angle');
legend('Direct','Costate Estimates');
